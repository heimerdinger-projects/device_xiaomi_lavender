...
BOARD_SUPER_PARTITION_SIZE := 6777995264 # 6464 MB
BOARD_SUPER_PARTITION_BLOCK_DEVICES := system vendor cust
BOARD_SUPER_PARTITION_METADATA_DEVICE := system
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3758096384 # 3580 MB
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 2147483648 # 2048 MB
BOARD_SUPER_PARTITION_CUST_DEVICE_SIZE := 872415232 # 832 MB
BOARD_SUPER_PARTITION_GROUPS := xiaomi_dynamic_partitions
BOARD_XIAOMI_DYNAMIC_PARTITIONS_PARTITION_LIST := $(ALL_PARTITIONS)
BOARD_XIAOMI_DYNAMIC_PARTITIONS_SIZE := 6773800960 # (BOARD_SUPER_PARTITION_SIZE - 4MB)

INITIAL_PARTITIONS := product system system_ext
ADDITIONAL_PARTITIONS := odm vendor
ALL_PARTITIONS := $(INITIAL_PARTITIONS) $(ADDITIONAL_PARTITIONS)
