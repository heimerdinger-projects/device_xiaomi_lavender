...
ifeq ($(WITH_GMS),true)
BOARD_XIAOMI_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 109051904 ) # BOARD_SUPER_PARTITION_SIZE - 104MB
else
BOARD_XIAOMI_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 696254464 ) # BOARD_SUPER_PARTITION_SIZE - 664MB
endif
